...
const treatments = [
  {
    ...
    items: [
      { title: 'Smile Designing', copy: 'Personalised smile enhancement planning with veneers, laminates, caps, and aesthetic fillings tailored to facial balance and dental harmony.', image: '/service-smile-designing.webp', duration: 'Custom', sessions: 'Planned in stages', bestFor: 'Customized smile transformation for a confident, natural-looking smile.' },
      { title: 'Facial Aesthetics', copy: 'Non-surgical facial aesthetic support including Botox and fillers when indicated for balanced, refreshed results.', image: '/service-facial-aesthetics.webp', duration: '30-60 min', sessions: 'As advised', bestFor: 'Subtle facial refinement that supports the overall smile and profile.' },
      { title: 'Teeth Whitening & Bleaching', copy: 'Professional bleaching, polishing, and tooth-coloured aesthetic finishing for discoloured teeth.', image: '/service-teeth-whitening.webp', duration: '45-90 min', sessions: '1-2', bestFor: 'Professional whitening treatment for a brighter smile.' },
      { title: 'Tooth-Coloured Cosmetic Fillings', copy: 'Natural-looking restorations used to rebuild decayed, chipped, or discoloured teeth.', image: '/service-tooth-coloured-fillings.webp', duration: '30-60 min', sessions: '1', bestFor: 'Small cavities, chips, or visible restorations that need a natural finish.' },
    ],
  },
  {
    category: 'Endodontics',
    items: [
      { title: 'Root Canal Treatment', copy: 'Treatment for toothache and deep cavities by removing infection and preserving the natural tooth whenever possible.', image: '/service-root-canal-treatment.webp', duration: '60-90 min', sessions: '1-2', bestFor: 'Pain-free root canal treatment focused on saving the natural tooth.' },
      { title: 'Severe Dental Pain Due To Infection', copy: 'Immediate relief planning and stabilising care for teeth that are severely painful due to infection.', image: '/service-emergency-dental-pain-care.webp', duration: '30-60 min', sessions: 'As needed', bestFor: 'Urgent pain relief when infection causes sensitivity, throbbing, or swelling.' },
      { title: 'Dental Swelling & Infection Management', copy: 'Focused treatment for facial swelling and oral infections caused by dental disease.', image: '/service-dental-swelling-infection.webp', duration: '30-90 min', sessions: 'Case-based', bestFor: 'Stabilising dental infections and preventing spread of swelling.' },
      { title: 'Broken & Traumatic Tooth Care', copy: 'Restoration planning for fractured teeth caused by sports injuries, accidents, or sudden dental trauma.', image: '/service-broken-traumatic-tooth-care.webp', duration: '45-90 min', sessions: 'Case-based', bestFor: 'Chipped, fractured, or injured teeth that need quick assessment.' },
    ],
  },
  {
    category: 'Orthodontics',
    items: [
      { title: 'Invisible Aligners', copy: 'Clear aligner therapy for modern, low-visibility smile correction with guided treatment sequencing.', image: '/service-invisible-aligners.webp', duration: '6-18 months', sessions: 'Planned refinements', bestFor: 'Clear aligners for discreet teeth straightening.' },
      { title: 'Metal Braces', copy: 'Reliable correction for crooked, crowded, or malaligned teeth using durable fixed orthodontic appliances.', image: '/service-metal-braces.webp', duration: '12-24 months', sessions: 'Monthly reviews', bestFor: 'Traditional reliable orthodontic treatment.' },
      { title: 'Ceramic Braces', copy: 'Aesthetic brace systems that blend more discreetly with natural teeth while correcting alignment effectively.', image: '/service-ceramic-braces.webp', duration: '12-24 months', sessions: 'Monthly reviews', bestFor: 'Tooth-coloured brackets for a discreet look.' },
      { title: 'Orthodontic Consultation & Diagnosis', copy: 'Assessment and treatment planning for bite correction, smile alignment, and dentofacial harmony.', image: '/service-orthodontic-consultation.webp', duration: '30-45 min', sessions: 'Initial + follow-up', bestFor: 'Understanding whether braces, aligners, or monitoring is right for you.' },
    ],
  },
  {
    category: 'Restorative Care',
    items: [
      { title: 'Dental Implants', copy: 'Long-term replacement of missing teeth with implant-supported restorations for function, stability, and a natural look.', image: '/service-dental-implants.webp', duration: '3-6 months', sessions: 'Multi-stage', bestFor: 'Permanent tooth replacement for confident smile and chewing support.' },
      { title: 'Removable Complete & Partial Dentures', copy: 'Custom dentures for single or multiple missing teeth, designed for comfort, appearance, and daily use.', image: '/service-dentures.webp', duration: '2-4 visits', sessions: '1 treatment plan', bestFor: 'Comfortable full or partial removable denture replacement.' },
      { title: 'Fixed Bridges & Crowns', copy: 'Replacement and reinforcement solutions including fixed bridges, tooth-coloured caps, and metal caps.', image: '/service-fixed-bridges-crowns.webp', duration: '2-3 visits', sessions: '1 treatment plan', bestFor: 'Natural-looking restoration and seamless gap replacement.' },
      { title: 'Broken Tooth Reconstruction', copy: 'Restorative options for severely broken teeth aimed at preserving teeth when extraction can be avoided.', image: '/service-broken-tooth-reconstruction.webp', duration: 'Case-based', sessions: 'Case-based', bestFor: 'Rebuilding badly damaged teeth when preservation is possible.' },
    ],
  },
  {
    category: 'General Dentistry',
    items: [
      { title: 'Professional Cleaning & Scaling', copy: 'Regular clean-up and scaling to remove deposits, improve gum health, and support fresher breath.', image: '/service-cleaning-scaling.webp', duration: '30-60 min', sessions: 'Every 6 months', bestFor: 'Deep cleaning for a healthier smile.' },
      { title: 'Bad Breath Management', copy: 'Diagnosis-led care for bad breath, combining professional cleaning, cause assessment, and practical counselling.', image: '/service-bad-breath-management.webp', duration: '30-45 min', sessions: 'As needed', bestFor: 'Identifying and treating the cause of persistent bad breath.' },
      { title: 'Tooth Extraction / Surgical Removal', copy: 'Tooth extraction or surgical removal for teeth that are severely damaged, infected, or badly broken.', image: '/service-broken-traumatic-tooth-care.webp', duration: '30-60 min', sessions: '1', bestFor: 'When a tooth cannot be predictably restored or causes repeated infection.' },
      { title: 'Oral & Facial Pain Management', copy: 'Evaluation and management of pain in the mouth and facial region with multidisciplinary planning when required.', image: '/service-emergency-dental-pain-care.webp', duration: '30-45 min', sessions: 'Case-based', bestFor: 'Unclear mouth, jaw, or facial pain needing careful diagnosis.' },
    ],
  },
]
